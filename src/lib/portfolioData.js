...
export const skills = {
  frontend: {
    ...
    items: ["React", "Next.js", "TypeScript", "Tailwind CSS", "HTML5 / CSS3", "Framer Motion", "D3.js", "Storybook"],
  },
  backend: {
    label: "Core Infrastructure",
    items: ["Node.js", "Express", "tRPC", "REST API", "GraphQL", "Prisma", "WebSockets"],
  },
  databases: {
    label: "Data Layer",
